...
export type GithubSvgIcons2SvgIconProps = React.ComponentProps<"svg"> & {
  title?: string;
};

export function GithubSvgIcons2SvgIcon(props: GithubSvgIcons2SvgIconProps) {
...
export default GithubSvgIcons2SvgIcon;
/* prettier-ignore-end */
