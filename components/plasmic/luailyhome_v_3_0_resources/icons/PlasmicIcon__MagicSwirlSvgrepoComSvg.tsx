...
export type MagicSwirlSvgrepoComSvgIconProps = React.ComponentProps<"svg"> & {
  title?: string;
};

export function MagicSwirlSvgrepoComSvgIcon(
  props: MagicSwirlSvgrepoComSvgIconProps
) {
...
export default MagicSwirlSvgrepoComSvgIcon;
/* prettier-ignore-end */
