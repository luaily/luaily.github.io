...
export type YouTubeVectorIconSvgIconProps = React.ComponentProps<"svg"> & {
  title?: string;
};

export function YouTubeVectorIconSvgIcon(props: YouTubeVectorIconSvgIconProps) {
...
export default YouTubeVectorIconSvgIcon;
/* prettier-ignore-end */
