...
export type ButterflyMonocolorSvgSvgIconProps = React.ComponentProps<"svg"> & {
  title?: string;
};

export function ButterflyMonocolorSvgSvgIcon(
  props: ButterflyMonocolorSvgSvgIconProps
) {
...
export default ButterflyMonocolorSvgSvgIcon;
/* prettier-ignore-end */
