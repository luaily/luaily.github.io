...
export type BurningMeteorSvgrepoComSvgIconProps =
  React.ComponentProps<"svg"> & {
    title?: string;
  };

export function BurningMeteorSvgrepoComSvgIcon(
  props: BurningMeteorSvgrepoComSvgIconProps
) {
...
export default BurningMeteorSvgrepoComSvgIcon;
/* prettier-ignore-end */
