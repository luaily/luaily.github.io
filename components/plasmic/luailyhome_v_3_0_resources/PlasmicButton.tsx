...
import sty from "./PlasmicButton.module.css"; // plasmic-import: f4pmll0-yeWS/css

import CheckSvgIcon from "./icons/PlasmicIcon__CheckSvg"; // plasmic-import: 4nfNViTXjFRj/icon
import Icon4Icon from "./icons/PlasmicIcon__Icon4"; // plasmic-import: z0_ChlteRSYW/icon
      ...
      {(hasVariant($state, "showStartIcon", "showStartIcon") ? true : false) ? (
        ...
        >
          {renderPlasmicSlot({
            defaultContents: (
              <CheckSvgIcon
                className={classNames(projectcss.all, sty.svg__qo6TO)}
                role={"img"}
              />
            ),
      ...
      {(hasVariant($state, "showEndIcon", "showEndIcon") ? true : false) ? (
        ...
        >
          {renderPlasmicSlot({
            defaultContents: (
              <Icon4Icon
                className={classNames(projectcss.all, sty.svg___7Jqmg)}
                role={"img"}
              />
            ),
