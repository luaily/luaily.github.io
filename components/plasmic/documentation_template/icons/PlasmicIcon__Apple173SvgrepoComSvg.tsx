...
export type Apple173SvgrepoComSvgIconProps = React.ComponentProps<"svg"> & {
  title?: string;
};

export function Apple173SvgrepoComSvgIcon(
  props: Apple173SvgrepoComSvgIconProps
) {
...
export default Apple173SvgrepoComSvgIcon;
/* prettier-ignore-end */
