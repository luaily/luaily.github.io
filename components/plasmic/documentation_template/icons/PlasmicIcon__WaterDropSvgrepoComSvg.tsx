...
export type WaterDropSvgrepoComSvgIconProps = React.ComponentProps<"svg"> & {
  title?: string;
};

export function WaterDropSvgrepoComSvgIcon(
  props: WaterDropSvgrepoComSvgIconProps
) {
...
export default WaterDropSvgrepoComSvgIcon;
/* prettier-ignore-end */
